function [y,D,nz,t_train,t_test] = sparsepct(params)
%SPARSEPCT sparse perfusion CT deconvolution.
%  [Y,D] = SPARSEPCT(PARAMS) denoises the specified (possibly
...
%
%  [Y,D,NZ] = SPARSEPCT(...) also returns the average number of non-zero
...
tic;
[y,nz] = lassoperfusion(params); % sparse perfuison using lasso
t_test = toc;
